...
-----
    # Dry run:
    fix-citestructure ../data-local/canonical-greekLit

    # Write changes:
    fix-citestructure ../data-local --write
"""
...
from perseus_cts.cts_resolver import _prefix_match_expr, CTSResolver, ConfigurationError
