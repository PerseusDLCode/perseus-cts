...
-----
    ...
    # Write the changes:
    fix-first-delim --write

    # Operate on specific paths:
    fix-first-delim ../data-local/canonical-greekLit --write
"""
...
from perseus_cts.constants import NS, TEI_NS, XML_PARSER as PARSER
...
def main() -> None:
    ...
    default_roots = [
        Path("data-local/canonical-greekLit"),
        Path("data-local/First1KGreek"),
        Path("data-local/csel-dev"),
    ]
