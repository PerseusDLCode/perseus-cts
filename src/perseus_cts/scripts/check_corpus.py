...
Usage
-----
    check-corpus ../data-local/canonical-greekLit ../data-local/First1KGreek
    check-corpus ../data-local --csv report.csv
    check-corpus ../data-local --show-ok
"""
...
from perseus_cts.constants import NS, TEI_NS, XML_PARSER as _PARSER
from perseus_cts.cts_resolver import CTSResolver, ConfigurationError
